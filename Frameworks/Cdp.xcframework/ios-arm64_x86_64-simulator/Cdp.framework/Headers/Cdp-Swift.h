...
@interface CdpConfig : NSObject <SFMCSdkModuleConfig>
...
SWIFT_CLASS_NAMED("CdpCoordinates")
@interface CdpCoordinates : NSObject <SFMCSdkCoordinates>
...
SWIFT_CLASS("_TtC3Cdp9CdpModule")
@interface CdpModule : NSObject <CdpInterface, SFMCModule, Subscriber>
...
/// Shared CdpModule Instance
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) CdpModule * _Nonnull shared;)
+ (CdpModule * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
/// Current state of the CdpModule instance
...
/// Return Module identity details
///
/// returns:
/// Module Identity
- (id <SFMCSdkModuleIdentity> _Nullable)getIdentity SWIFT_WARN_UNUSED_RESULT;
/// Sets the “isAnonymous” attribute on the profile to “1”
- (void)setProfileToAnonymous;
/// Sets the “isAnonymous” attribute on the profile to “0”
- (void)setProfileToKnown;
